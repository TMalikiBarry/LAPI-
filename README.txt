...
a persistence unit "LonaciAPIPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "LonaciAPI\pom.xml":
...
artifacts ("LonaciAPI-ejb.jar" and "LonaciAPI-web.war") are already built. You can build
