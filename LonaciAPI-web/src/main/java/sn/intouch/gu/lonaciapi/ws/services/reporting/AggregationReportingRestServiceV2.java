...
public class AggregationReportingRestServiceV2 {
    ...
    @RequestMapping(value = {"/api/v1/aggregation/curve-v2"}, method = RequestMethod.GET, produces = "application/json")
    ...
    @RequestMapping(value = {"/api/v1/aggregation/header-v2"}, method = RequestMethod.GET, produces = "application/json")
    public ResponseEntity<APIResponse<CategorisationResponse<HeaderResponse>>> header(
            @RequestParam(value = "operator", required = false) String operator,
            @RequestParam(value = "type", required = false) String type
    ) throws RuntimeException {
        
        CategorisationResponse<HeaderResponse> response = CategorisationResponse.<HeaderResponse>builder()
    ...
    private HeaderResponse getHeaderResponse(String operator, String type, String category) {
    ...
    @RequestMapping(value = {"/api/v1/aggregation/sub-header-v2"}, method = RequestMethod.GET, produces = "application/json")
    ...
    @RequestMapping(value = {"/api/v1/aggregation/trend-v2"}, method = RequestMethod.GET, produces = "application/json")
    public ResponseEntity<APIResponse<CategorisationResponse<TrendResponse>>> trend(
            @RequestParam(value = "operator", required = false) String operator,
            @RequestParam(value = "type", required = false) String type
    ) throws RuntimeException {
        CategorisationResponse<TrendResponse> response = CategorisationResponse.<TrendResponse>builder()
    ...
    private TrendResponse getTrendResponse(String operator, String type, String category) {
     ...
     * @throws RuntimeException
     */
    @RequestMapping(value = {"/api/v1/aggregation/report-V2"}, method = RequestMethod.GET, produces = "application/json")
